...
<div class="box">
    ...
    <div class="col-4">
      <button class="btn btn-primary " data-toggle="modal" data-target="#modal-insert"> Add Shift</button>
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td><a class="waves-effect  btn  btn-success btn-xs mb-5"
                       onclick='editDept(" {{ $dept->id }}", "{{ $dept->name }}", "{{ $dept->inTime }}", "{{ $dept->outTime }}" )'
    ...
    <div class="modal fade" id="modal-edit">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form action=" {{ route('ShiftUpdate') }}   " method="post">
            @csrf
          ...
          <div class="form-group">
            <input type="text" name="name" id="inTime" class="form-control">
          </div>
          <div class="form-group">
            <input type="text" name="name" id="outTime" class="form-control">
          </div>
...
<div class="modal fade"  id="modal-insert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action=" {{ route('shiftInsert') }}  " method="post">
        @csrf
      <div class="modal-header">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="inTime " placeholder="in Time" id="">
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="outTime" placeholder="out Time" id="">
      </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        <div class="modal-header">
          ...
          <form action="{{ route('shiftDelete') }}" method="post">
            @csrf
...
function editDept(id, name  inTime outTime){
