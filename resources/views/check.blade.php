...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/dependencies/fontawesome/css/fontawesome-all.min.css') }}"
        type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/slick-carousel/css/slick.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/slick-carousel/css/slick-theme.css') }}"
        type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/simplebar/css/simplebar.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/aos/css/aos.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/vegas/css/vegas.min.css') }}" type="text/css">
    <link rel="stylesheet"
        href="{{ asset('front/dependencies/malihu-custom-scrollbar-plugin/css/jquery.mCustomScrollbar.min.css') }}"
        type="text/css">
    <link rel="stylesheet" href="{{ asset('front/dependencies/venobox/css/venobox.css') }}" type="text/css">
    <link rel="stylesheet"
    ...
    <!-- San Fransisco Fonts -->
    <link href="{{ asset('front/dependencies/SanFrasiscoPro/css/stylesheet.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <section class="slider-wrapper">
        ...
        <div class="slider">
            <div class="bounce mt-5">
                <img src="{{ asset('front/tg.png') }} " class="fa" alt="">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="slider-text-inner">
                            <img src="{{ asset('front/bgi.png') }}" width="450" />
                            <div class="sleider-heading">
                                <h1 style="color: darkolivegreen">BGI<br>ETHIOPIA <br> <span>ATTENDANCE<br> CHECK
                                        POINT</span></h1>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
